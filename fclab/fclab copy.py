...
class fclab(object):
    ...
    def __init__(self, port=None, baud=9600, debug=False):
        ...
        if self.sp.isOpen():
            print('fclab connected on port ' + port)
    ...
    def close(self):
        try:
            ...
            print('Problem encountered while disconnecting from fclab.')
            print('Please unplug and replug fclab.')
        return
